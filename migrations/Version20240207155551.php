 ...
 */
final class Version20240207155551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cow (id INT AUTO_INCREMENT NOT NULL, fazenda_id INT DEFAULT NULL, codigo INT NOT NULL, qt_leite DOUBLE PRECISION DEFAULT NULL, qt_racao DOUBLE PRECISION NOT NULL, peso DOUBLE PRECISION NOT NULL, nascimento DATE NOT NULL, INDEX IDX_99D43F9CD4A3545F (fazenda_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE farm (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(50) NOT NULL, tamanho DOUBLE PRECISION NOT NULL, responsavel VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE veterinarian (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(50) NOT NULL, crmv VARCHAR(15) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
